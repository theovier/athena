...
import com.theovier.athena.client.ecs.components.TalosParticle
import com.theovier.athena.client.ecs.prefabs.loaders.DependencyPool
import ktx.assets.async.AssetStorage
import ktx.assets.async.toIdentifier


class TalosParticleComponentLoader(private val assets: AssetStorage) : ComponentLoader {

    override fun load(componentJSON: JsonValue, dependencyPool: DependencyPool): TalosParticle {
        val component = TalosParticle()
